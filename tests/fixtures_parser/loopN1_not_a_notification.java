...
// shape. `names` holds String, which is not a project type, and the call is a print, not a
// callback on an observer. Detecting form 1 must not degrade into detecting any enhanced-for.
//
